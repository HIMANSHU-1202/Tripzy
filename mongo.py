...
MONGO_URL = os.environ.get(
    'MONGO_URL',
    'mongodb+srv://hghaste_db_user:Ghaste9119@cluster0.9n0k1zt.mongodb.net/tripzy?retryWrites=true&w=majority&appName=Cluster0'   # empty = disabled, falls back to PostgreSQL
)
